...
updated_at_T = Annotated[datetime, mapped_column(DateTime, server_default=sql_utc_now, onupdate=sql_utc_now)]
...
int_or_none = Annotated[int | None, mapped_column(Integer, nullable=True, default=None)]
